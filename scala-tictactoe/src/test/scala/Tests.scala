class Tests extends org.scalatest.FunSuite {
  ...
  test("CreateBoard2") {
    ...
    val gameBoard4 = Solution.createGame(O, 3, Map((0, 0) -> O, (1, 0) -> O, (2, 0) -> O,
                                                   ...
                                                   (0, 2) -> X, (1, 2) -> X)    )                                           
    //assert(minimax(new Game(X, 3, Map())) == None)
    assert(gameBoard4.isFinished() == false)


  }
  test("nextBoards") {
    val gameBoard = Solution.createGame(O, 3, Map((0, 0) -> X, (1, 0) -> X, 
                                                                (1, 1) -> O,
                                                   (0, 2) -> X, (1, 2) -> O, (2, 2) -> O))

    val sol1 = Solution.createGame(O, 3, Map((0, 0) -> X, (1, 0) -> X, 
                                                                (1, 1) -> O, (2, 1) -> O,
                                                   (0, 2) -> X, (1, 2) -> O, (2, 2) -> O)) 

    val sol2 = Solution.createGame(O, 3, Map((0, 0) -> X, (1, 0) -> X, (2, 0) -> O,
                                                                (1, 1) -> O, 
                                                   (0, 2) -> X, (1, 2) -> O, (2, 2) -> O)) 

    val sol3 = Solution.createGame(O, 3, Map((0, 0) -> X, (1, 0) -> X, 
                                                   (0, 1) -> O, (1, 1) -> O, (2, 1) -> O,
                                                   (0, 2) -> X, (1, 2) -> O, (2, 2) -> O))                             
    //assert(minimax(new Game(X, 3, Map())) == None)
    assert(gameBoard.nextBoards() == List[Game](sol1, sol2, sol3))
